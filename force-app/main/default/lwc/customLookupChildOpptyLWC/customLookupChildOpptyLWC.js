...
import searchLookupData from '@salesforce/apex/CustomLookupChildOpptyLWCController.searchLookupData';
import searchDefaultRecord from '@salesforce/apex/CustomLookupChildOpptyLWCController.searchDefaultRecord';
 
export default class CustomLookupChildOpptyLWCC extends LightningElement {
   ...
   // initial function to populate default selected lookup record if defaultRecordId provided  
    connectedCallback(){
        console.log('pricebookkkkkk--'+this.pricebook);
    ...
    @wire(searchLookupData, { searchKey: '$searchKey' , sObjectApiName : '$sObjectApiName', pricebookId: '$pricebook' })
     searchResult(value) {
        const { data, error } = value; // destructure the provisioned value
        this.isSearchLoading = false;
        if (data) {
            console.log('dattttaaaattt--'+JSON.stringify(data));
